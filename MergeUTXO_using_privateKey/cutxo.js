...
const msgPrefix = process.env.MESSAGEPrifix;
const pub = process.env.bip32PUB;
const priv = process.env.bip32PRIV;
const keyhash = process.env.pubKeyHash;
const script = process.env.scriptHash;
const wiff = process.env.WIF;
